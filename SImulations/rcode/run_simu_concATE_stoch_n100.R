...
for(th in seq_th){
  ...
  k <- k+1 
    ...
    bias_aipw_point_all_we_S[k] <- (mean(aipw_point_all_S,na.rm = TRUE) - mean(true))
    ...
    se_aipw_point_all_we_sv_S[k] <- sd(aipw_point_all_S,na.rm = TRUE)
    ...
    se_aipw_point_all_we_if_S[k] <- mean(aipw_se_all_S,na.rm = TRUE)
    ...
    ratio_aipw_oc_we_vs_all_S[k] <- sd(aipw_point_oc_we,na.rm = TRUE)/sd(aipw_point_all_S,na.rm = TRUE)
    ...
    M_mse_aipw_point_all_we_S[k] <- mean(mse_aipw_point_all_we_S,na.rm = TRUE)
    ...
    M_coverage_aipw_all_S[k] <- mean(coverage_aipw_point_all_w_S,na.rm = TRUE)    
...
#save.image("/Users/santam13/Documents/NYU/Non concurrent/Ident-Estima-Parametric/rcode/non-concurrent/data_simu/Correct-Outcome Correct-Treatment_11.15.24 - Stochastic_n100.RData")
save.image("/Users/santam13/Documents/NYU/Non concurrent/Ident-Estima-Parametric/rcode/non-concurrent/data_simu/Miss-Outcome Correct-Treatment_11.15.24 - Stochastic_n100.RData")
